...
#
# HOW TO USE:
#   1. Replace "cis410-delphin-tfstate" with your actual bucket name
...
terraform {
  ...
  #
  # REPLACE: change cis410-delphin-tfstate to your actual bucket name.
  # Find it: GCP Console → Cloud Storage → Buckets
  backend "gcs" {
    bucket = "cis410-delphin-tfstate"   # ← replace with your bucket name
